...
import {createBrokerApiRouteHandlers} from '../http/requestHandler'
...
import {WorkloadManifestController} from './controllers/workloadManifestController'
import {
  ...
  public static register(options: BrokerApiNestModuleOptions): DynamicModule {
    return {
      ...
      providers: [
        ...
        {
          provide: BROKER_API_ROUTE_HANDLERS,
          inject: [
            BROKER_API_CONFIG,
            BROKER_API_REPOSITORY,
            BROKER_API_AUDIT_SERVICE,
